 ...
 *
 * 真值：HandoverController（/api/v1/handovers，2026-09-06 磁盘核实）、PmDirectoryController
 ...
 * GET /handovers/inbox（待我接收+我发起的未完结）、POST /handovers/super-admin
 * （P2-7.3 超管移交，confirmation 确认短语）。
 *
 * 与原型 /api/handoffs 不同构（逐条登记）：原型 preview（未完成动作/资料/待决/AI 会话
 * 四卡 scope + approvals 责任确认链）、decision(approved/rejected)、cancel、
 * product-continuation、handoff-candidates 后端均未交付；后端 accept 单动作即原子完成，
...
/** 移交记录（HandoverController.HandoverView；status: DRAFT | COMPLETED）。 */
